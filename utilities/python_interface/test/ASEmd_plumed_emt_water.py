...
ts = 0.5 #timestep
ASEmd = ase.md.VelocityVerlet(ASEatoms,ts*ase.units.fs)
...
#shutil.move('ENERGY.xyz','Outputs/ASEmd_plumed_emt_water.xyz')
#shutil.move('PLUMED/COLVAR','Outputs/ASEmd_plumed_emt_water.col')
#shutil.move('PLUMED/HILLS','Outputs/ASEmd_plumed_emt_water.hil')
